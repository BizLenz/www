...
let mockStatus: "authenticated" | "unauthenticated" | "loading" =
  "unauthenticated";

// --- Mock Functions ---
const mockSignIn = jest.fn(
  (provider?: string | BuiltInProviderType, options?: SignInOptions) =>
...
const mockSignOut = jest.fn(
  (options?: SignOutParams) =>
    ...
    }), // Adjust mock return based on your needs
);

// --- Helper for setting mock state in tests ---
export const mockSetSession = (
