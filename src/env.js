...
export const env = createEnv({
    ...
    runtimeEnv: {
        ...
        NEXT_PUBLIC_AUTH_COGNITO_DOMAIN: process.env.NEXT_PUBLIC_AUTH_COGNITO_DOMAIN,
        NEXT_PUBLIC_AUTH_COGNITO_CLIENT_ID: process.env.NEXT_PUBLIC_AUTH_COGNITO_CLIENT_ID,
