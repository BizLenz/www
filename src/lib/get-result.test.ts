...
describe("getResult", () => {
  ...
  it("returns normalized analysis result", async () => {
    ...
    const result = await getResult("123", makeSession());
  ...
  it("passes access token to serverFetch", async () => {
    ...
    await getResult("123", makeSession());
...
describe("getFinancialAnalysis", () => {
  ...
  it("returns financial analysis data", async () => {
    ...
    const result = await getFinancialAnalysis("123", makeSession());
  ...
  it("passes the correct endpoint URL", async () => {
    ...
    await getFinancialAnalysis("42", makeSession());
...
describe("getMarketAnalysis", () => {
  ...
  it("returns market analysis data", async () => {
    ...
    const result = await getMarketAnalysis("123", makeSession());
  ...
  it("passes the correct endpoint URL", async () => {
    ...
    await getMarketAnalysis("42", makeSession());
...
describe("getRiskAnalysis", () => {
  ...
  it("returns risk analysis data", async () => {
    ...
    const result = await getRiskAnalysis("123", makeSession());
  ...
  it("passes the correct endpoint URL", async () => {
    ...
    await getRiskAnalysis("42", makeSession());
...
describe("getTechnicalAnalysis", () => {
  ...
  it("returns technical analysis data", async () => {
    ...
    const result = await getTechnicalAnalysis("123", makeSession());
  ...
  it("passes the correct endpoint URL", async () => {
    ...
    await getTechnicalAnalysis("42", makeSession());
